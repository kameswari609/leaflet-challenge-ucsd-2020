...
// GET request to the query URL to get the earthquake data
...
//return color based on value
  ...
  function style(feature) {
    ...
    // Run the onEachFeature function once for each piece of feature 
...
function createMap(earthquakes) {
  ...
  // Create the map, giving it the streetmap and earthquakes layers to display ON MAP
  var myMap = L.map("map", {
    center: [
      40.7,-94.5
    ],
...
legend.onAdd = function (map) {
    ...
    // loop through our GRADE  and generate a label with a colored square for each interval
